        ...
        if (mounted) {
          setState(() {
            exercises = data.where((exercise) {
              final matchesTarget = selectedTarget == null ||
            ...
            isLoading = false;
            exerciseStates = List.generate(exercises.length, (index) => false);
          });
        }
      } else {
            ...
            Container(
                decoration: BoxDecoration(
                   shape: BoxShape.circle,
                    color: exerciseStates[index] ? Colors.black : Colors.neutral[100]
                    ),
                child: OutlineButton(
                    ...
                    onPressed: () {
                      setState(() {
                        // Update the exercise state and add the exercise to the list
                        exerciseStates[index] = !exerciseStates[index];
                    ...
                    child: exerciseStates[index] ? Icon(BootstrapIcons.check, color: Colors.white) : Icon(BootstrapIcons.plus, color: Colors.black,)))
          ],
        ),
      ),
    );
